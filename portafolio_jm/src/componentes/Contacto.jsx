...
export const Contacto = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <label htmlFor="name" className="block mb-1 text-sm font-medium w-fit px-3 py-1">
            Nombre
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="email" className="block mb-1 text-sm font-medium w-fit px-3 py-1">
            Correo electrónico
          </label>
          <input
            type="email"
        ...
        <div>
          <label htmlFor="message" className="block mb-1 text-sm font-medium w-fit px-3 py-1">
            Mensaje
          </label>
          <textarea
            name="message"
